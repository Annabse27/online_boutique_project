...
class TestCartAPI:
    ...
    def test_add_to_cart(self):
        ...
        subcategory = SubCategory.objects.create(name='Smartphones', slug='smartphones', category=category)
        product = Product.objects.create(name='iPhone', slug='iphone', price=1000, subcategory=subcategory)
    ...
    def test_clear_cart(self):
        ...
        assert response.status_code == 200
        assert 'message' in response.data  # Проверяем, что в ответе есть сообщение об успешной очистке
